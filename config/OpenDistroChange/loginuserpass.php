...
?>  
    <img alt="" style="width:300px;margin:auto" src="/<?php echo $this->data['baseurlpath']; ?>resources/open_distro_for_elasticsearch_logo_h.svg" />
    <h2 style="break: both;text-align:center;"><?php echo $this->t('{login:user_pass_header}'); ?></h2>

    <form action="?" method="post" name="f" style="text-align:center;">
        <table style="margin:auto;">
            ...
            ?>
            <tr id="submit">
                <td class="loginicon"></td>
                <td>
                    <button id="submit_button" class="btn" tabindex="6" style="margin:auto;">
